...
rgCheck = function (el) {
    document.getElementById('rgResponse').innerHTML = MascaraRg(el.value)? '<span style="color:green">CPF válido</span>' : '<span style="color:red">CPF inválido</span>';
    if(el.value=='') document.getElementById('rgResponse').innerHTML = '';
}
